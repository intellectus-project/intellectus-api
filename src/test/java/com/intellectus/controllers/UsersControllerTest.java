...
class UsersControllerTest {
    ...
    void findAll() throws Exception{
        Mockito.when(roleRepository.findByCode(com.intellectus.model.constants.Role.ROLE_ADMIN.role()))
                .thenReturn(Role.builder().code(com.intellectus.model.constants.Role.ROLE_ADMIN.role()).id(1).build());
