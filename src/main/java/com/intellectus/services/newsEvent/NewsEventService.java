...
public class NewsEventService {
    ...
    public List<NewsEventDto> fetchByDate(LocalDate date) {
        return newsEventRepository.findAllByCreatedBetween(date.atStartOfDay().minusDays(2), date.atTime(LocalTime.MAX));
    }
}
